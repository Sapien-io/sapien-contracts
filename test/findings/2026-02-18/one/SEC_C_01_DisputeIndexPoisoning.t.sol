...
contract SEC_C_01_DisputeIndexPoisoning is BaseTest {
    ...
    function test_nonceKeyedDisputeDoesNotBlockNewContributor() public {
        ...
        _claimAndCommit(validator1, projectId, targetIndex, 3000, VALIDATOR_STAKE);
        _claimAndCommit(validator2, projectId, targetIndex, 3000, VALIDATOR_STAKE);
        _claimAndCommit(validator3, projectId, targetIndex, 3000, VALIDATOR_STAKE);
        _reveal(validator1, projectId, targetIndex, 3000);
        _reveal(validator2, projectId, targetIndex, 3000);
        _reveal(validator3, projectId, targetIndex, 3000);
        ...
        _claimAndCommit(validator1, projectId, recycledIndex, 8000, VALIDATOR_STAKE);
        _claimAndCommit(validator2, projectId, recycledIndex, 8000, VALIDATOR_STAKE);
        _claimAndCommit(validator3, projectId, recycledIndex, 8000, VALIDATOR_STAKE);
        _reveal(validator1, projectId, recycledIndex, 8000);
        _reveal(validator2, projectId, recycledIndex, 8000);
        _reveal(validator3, projectId, recycledIndex, 8000);
