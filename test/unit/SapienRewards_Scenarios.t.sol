...
contract SapienRewardsScenariosTest is Test {
    ...
    function test_Rewards_Scenario_CompleteRewardsLifecycle() public {
        ...
        bytes memory charlieSignature = _createSignature(charlie, SMALL_REWARD, CHARLIE_ORDER_1, rewardManager1PrivateKey);
        vm.prank(charlie);
    ...
    function test_Rewards_Scenario_MultiManagerCoordination() public {
        ...
        bytes memory communityReward1 = _createSignature(charlie, MEDIUM_REWARD, CHARLIE_ORDER_1, rewardManager2PrivateKey);
