...
contract SapienTokenIntegrationTest is Test {
    ...
    function test_Token_TokenDistribution_Simulation() public {
    ...
    function test_Token_Permit_IntegrationWithTransfers() public {
    ...
    function test_Token_BatchTransfers_GasEfficiency() public {
        uint256 amount = 1000 * 10 ** 18;
    ...
    function test_Token_MaxApproval() public {
        vm.startPrank(treasury);
    ...
    function test_Token_ZeroValueTransfers() public {
        vm.startPrank(treasury);
    ...
    function test_Token_SelfTransfer() public {
        uint256 amount = 1000 * 10 ** 18;
    ...
    function test_Token_ManySmallTransfers() public {
    ...
    function test_Token_TotalSupplyInvariant() public {
        uint256 amount = 1000 * 10 ** 18;
