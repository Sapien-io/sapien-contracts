...
contract StakingVaultTest is Test {
    ...
    function test_IncreaseLockup() public {
        ...
        (,,,,,, uint256 effectiveLockUpPeriod, uint256 timeUntilUnlock) = 
            stakingVault.getUserStakingSummary(user1);
    ...
    function test_CompleteUnstakingFlow() public {
        ...
        (, /* totalUnlocked */, /* totalLocked */, uint256 totalInCooldown,,,,) = stakingVault.getUserStakingSummary(user1);
    ...
    function test_GetUserStakingSummary() public {
        ...
        {
            (,uint256 unlocked, uint256 locked, uint256 inCooldown, uint256 readyForUnstake,,,) = stakingVault.getUserStakingSummary(user1);
            assertEq(unlocked, stakeAmount / 2); // Half still unlocked and available
            assertEq(locked, 0);
